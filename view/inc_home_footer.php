    ...
    <div id="Id_Right_Drawer_Mask"
         style="position:fixed;width:110%;height:100%;background:#000;top:0;right:0;z-index:999;opacity:0.2;display:none;overflow-y:scroll;text-align:center;"
    ...
    <style type="text/css">
      .drawer_content_right {
        position:fixed;width:700px;height:100%;text-align:left;
         background:#FFF;top:0;right:-1000px;z-index:999;
         opacity:1; padding:20px 20px 40px 30px;
    ...
    <script type="text/javascript">
      ...
      $(document.body).click(function(event){
        // alert( event. 'alert body')
        $$.event.pub('CLICK_SOMTHING',event)
      })
